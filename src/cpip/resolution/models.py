...
# These records are written out rather than generated by dataclasses: the
# dataclasses module (and inspect behind it) is several milliseconds of
# import on every cpip process, for three classes whose __init__, __eq__,
# __hash__ and __repr__ are a few lines each.
